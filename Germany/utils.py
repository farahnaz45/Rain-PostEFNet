...
from model.swinunet_model import SwinUnet,SwinUnet_CAM,SwinUnet_Two,SwinUnet_CAM_Two
...
def parse_args(manual_input=None):
    ...
    common.add_argument('--model', default='SwinUnet_CAM_Two', type=str, help='which model to use [unet, attn_unet, convlstm]')
    ...
    common.add_argument('--input_data', default="gdaps_kim", type=str, help='input data: gdaps_kim, gdaps_um, ldaps')
    ...
    common.add_argument('--start_lead_time', type=int, default=24,
                        help='start of lead_time (how many hours between origin time and prediction target time) range, inclusive')
    common.add_argument('--end_lead_time', type=int, default=24,
    ...
    common.add_argument('--use_two', default=True, help='use regression and classification', action='store_true')
    ...
    common.add_argument('--rain_thresholds', default=[0.00001, 2.0], type=float, nargs='+',
    ...
    common.add_argument('--custom_name', default="output", type=str, help='add customize experiment name')
    common.add_argument('--experiment_name', default="output", type=str,
    ...
    nims_dataset.add_argument('--window_size', default=8, type=int, help='# of input sequences in time')
    ...
    hyperparam.add_argument('--lr', default=0.01, type=float, help='learning rate of optimizer')
    hyperparam.add_argument('--momentum', default=0.0, type=float, help='momentum')
    hyperparam.add_argument('--wd', default=0.1, type=float, help='weight decay')
