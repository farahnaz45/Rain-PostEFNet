...
def main(args):
    ...
    trn_x = np.load('Germany_data/01_trn_x.npy')
    trn_y = np.load('Germany_data/01_trn_y.npy')
    tst_x = np.load('Germany_data/01_tst_x.npy')
    tst_y = np.load('Germany_data/01_tst_y.npy')
    vld_x = np.load('Germany_data/01_vld_x.npy')
    vld_y = np.load('Germany_data/01_vld_y.npy')
