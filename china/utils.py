...
from model.swinunet_model import SwinUnet,SwinUnet_Two,SwinUnet_CAM_Two
...
def parse_args(manual_input=None):
    ...
    common.add_argument('--rain_thresholds', default=[0.1, 2.0], type=float, nargs='+',
    ...
    common.add_argument('--experiment_name', default="experiment", type=str,
    ...
    nims_dataset.add_argument('--window_size', default=5, type=int, help='# of input sequences in time')
